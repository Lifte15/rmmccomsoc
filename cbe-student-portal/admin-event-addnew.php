...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CBE') {
  ...
  <head>
    ...
    <title>Admin Create New Event Page | CBE Student Portal</title>
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" id="jpia" name="organization[]"
                                value="Junior Philippine Institute of Accountants RMMC Gensan Chapter" <?php if (in_array('Junior Philippine Institute of Accountants RMMC Gensan Chapter', $organizations))
                                  echo 'checked'; ?>>
                              <label class="form-check-label" for="jpia">Junior Philippine Institute of Accountants RMMC Gensan Chapter</label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" id="psc" name="organization[]" value="Philippine Society of Customs"
                                <?php if (in_array('Philippine Society of Customs', $organizations))
                                  echo 'checked'; ?>>
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" id="pasoa" name="organization[]"
                                value="Philippine Association of Students in Office Administration" <?php if (in_array('Philippine Association of Students in Office Administration', $organizations))
                                  echo 'checked'; ?>>
                              <label class="form-check-label" for="pasoa">Philippine Association of Students in Office Administration</label>
                            </div>
                          <?php } else { ?>
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" id="dsc" name="organization[]" value="DSC">
