...
function sendMail($email, $v_code, $last_name, $first_name, $middle_name, $program, $year_level, $username)
{
    ...
    try {
        ...
        $mail->setFrom('studentportal.comsoc@gmail.com', 'Account Verification Code | CBE Student Portal');
        $mail->addAddress($email);

        $mail->isHTML(true);
        $mail->Subject = 'Hello CBE Student | CBE Student Portal';
        $mail->Body = "
        <html>
        ...
        <head>
            ...
            <body>
                <div class='container'>
                    ...
                    <hr>
                    <h3>To finalize your CBE Student Portal account, please verify your account using the following verification code:</h3>
