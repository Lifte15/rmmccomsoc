...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CBE') {
    ...
    <head>
        ...
        <title>Admin Edit Officer | CBE Student Portal </title>
                                ...
                                <div class="card card-primary card-outline bg-white" for="new-subject">
                                    <div class="card-header">
                                        <form action="indexes/admin-officer-edit-be.php" method="post">
                                            ...
                                            $sql = "SELECT * FROM user WHERE account_number = '$account_number' AND department='CBE'";
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" id="position" name="organization">
                                                                ...
                                                                <option value="Junior Philippine Institute of Accountants RMMC Gensan Chapter" <?php if ($organization == 'Junior Philippine Institute of Accountants RMMC Gensan Chapter') echo 'selected'; ?>>Junior Philippine Institute of Accountants RMMC Gensan Chapter</option>
                                                                <option value="Philippine Society of Customs" <?php if ($organization == 'Philippine Society of Customs') echo 'selected'; ?>>Philippine Society of Customs</option>
                                                                <option value="Philippine Association of Students in Office Administration" <?php if ($organization == 'Philippine Association of Students in Office Administration') echo 'selected'; ?>>Philippine Association of Students in Office Administration</option>
                                                            </select>
                                                        </div>
                                                    </div>
