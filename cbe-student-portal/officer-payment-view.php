...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CBE') { // Check if the role is set and it's 'Admin'
    ?>
    ...
    <head>
        ...
        <title>Admin Payment View | CBE Student Portal </title>
                                        ...
                                        <div class="table-responsive">
                                            <table class="subject-info">
                                                ...
                                                if (isset($_GET['payment_for_id'])) {
                                                    ...
                                                    $eventsql = "SELECT * FROM payment_for WHERE payment_for_id = '$payment_for_id' AND department='CBE'";
