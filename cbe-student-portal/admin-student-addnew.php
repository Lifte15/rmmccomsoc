...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CBE') { // Check if the role is set and it's 'Admin'
  ?>
  ...
  <head>
    ...
    <title>Admin Add New Student | CBE Student Portal</title>
                        ...
                        <div class="col-sm-12">
                          <?php if (isset($_GET['program'])) { ?>
                            <select class="form-control" id="program" name="program">
                              ...
                              <option value="BSA" <?php if ($_GET['program'] == 'BSA')
                                echo 'selected'; ?>>BSA</option>
                              <option value="BSMA" <?php if ($_GET['program'] == 'BSMA')
                                echo 'selected'; ?>>BSMA</option>
                              <option value="BSBA-FM" <?php if ($_GET['program'] == 'BSBA-FM')
                                echo 'selected'; ?>>BSBA-FM</option>
                              <option value="BSBA-MM" <?php if ($_GET['program'] == 'BSBA-MM')
                                echo 'selected'; ?>>BSBA-MM</option>
				<option value="BSBA-OM" <?php if ($_GET['program'] == 'BSBA-OM')
                                echo 'selected'; ?>>BSBA-OM</option>
                              <option value="BSOA" <?php if ($_GET['program'] == 'BSOA')
                                echo 'selected'; ?>>BSOA</option>
                              <option value="BSCA" <?php if ($_GET['program'] == 'BSCA')
                                echo 'selected'; ?>>BSCA</option>
                              <option value="BSREM" <?php if ($_GET['program'] == 'BSREM')
                                echo 'selected'; ?>>BSREM</option>
                              <option value="BSTM" <?php if ($_GET['program'] == 'BSTM')
                                echo 'selected'; ?>>BSTM</option>
                              <option value="BSHM" <?php if ($_GET['program'] == 'BSHM')
                                echo 'selected'; ?>>BSHM</option>
                            </select>
