...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CBE') { // Check if the role is set and it's 'Admin'
  ...
  <head>
    ...
    <title>Admin Payment Page | CBE Student Portal </title>
                ...
                <tbody>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    if (!empty($conditions)) {
                      ...
                      $eventssql = "SELECT * FROM payment_for WHERE $condition_string AND payment_description LIKE '%$search_input%'  AND department='CBE'";
                    } else {
                      $eventssql = "SELECT * FROM payment_for WHERE payment_description LIKE '%$search_input%' AND department='CBE'";
                    }
                  } else {
                    $eventssql = "SELECT * FROM payment_for WHERE department='CBE'";
                  }
