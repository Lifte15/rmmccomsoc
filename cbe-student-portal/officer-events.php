...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CBE') {
  ...
  <head>
    ...
    <title>Officer Events Page | CBE Student Portal</title>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    if (!empty($conditions)) {
                      ...
                      if (!empty($search_input)) {
                        $eventssql = "SELECT * FROM events WHERE $condition_string AND event_name LIKE '%$search_input%' AND department='CBE' AND FIND_IN_SET('$organization', organization)";
                    } else {
                      $eventssql = "SELECT * FROM events WHERE $condition_string AND department='CBE' AND FIND_IN_SET('$organization', organization)";
                    }
                  } else {
                    if (!empty($search_input)) {
                      $eventssql = "SELECT * FROM events WHERE event_name LIKE '%$search_input%' AND department='CBE' AND FIND_IN_SET('$organization', organization)";
                  } else {
                      $eventssql = "SELECT * FROM events WHERE department='CBE' AND FIND_IN_SET('$organization', organization)";
                  }
                  }
                } else {
                  $organization = mysqli_real_escape_string($conn, $_SESSION['organization']);
