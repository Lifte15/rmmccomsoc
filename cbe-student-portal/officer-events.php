...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CBE') { // Check if the role is set and it's 'Admin'
  ...
  <head>
    ...
    <title>Admin Events Page | CBE Student Portal</title>
                ...
                <tbody>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    if (!empty($conditions)) {
                      ...
                      $eventssql = "SELECT * FROM events WHERE $condition_string AND event_name LIKE '%$search_input%' AND department='CBE'";
                    } else {
                      $eventssql = "SELECT * FROM events WHERE event_name LIKE '%$search_input%' AND department='CBE'";
                    }
                  } else {
                    $eventssql = "SELECT * FROM events WHERE department='CBE'";
                  }
