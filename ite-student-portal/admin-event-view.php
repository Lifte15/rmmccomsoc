                                ...
                                <div class="row mb-2 align-items-center">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        <a id="addNewSubjectBtn" class="btn btn-secondary"
                                            href="admin-events.php?search_input=&date=&school_year=<?php echo $row['school_year']; ?>&semester=<?php echo $row['semester']; ?>&search="><i
                                                            ...
                                                            <td class="align-middle text-center">
                                                                <form method="POST" action="indexes/admin-event-checking-be.php">
                                                                    ...
                                                                    <input type="hidden" name="account_number"
                                                                        value="<?php echo $studentrow['account_number']; ?>">
                                                                    <?php if ($studentrow['remarks'] == 'Present') { ?>
