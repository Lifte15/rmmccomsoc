...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'ITE') { 
  ...
  <head>
    ...
    <title>Officer Add New Event | ITE Student Portal</title>
                  ...
                  <div class="card-header">
                    ...
                    <form action="indexes/officer-add-event-be.php" method="post">
                      ...
                      <div class="offset-sm-2 col-sm-10">
                        ...
                        <a type="button" name="cancel" class="btn btn-secondary" href="officer-events.php?search_input=&date=&school_year=<?php echo $defaultYear; ?>&semester=<?php echo $defaultSemester; ?>&search=">Cancel</a>
                      </div>
