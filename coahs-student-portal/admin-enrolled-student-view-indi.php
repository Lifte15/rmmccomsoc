...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'COAHS') {
    ...
    <head>
        ...
        <title>Admin Student View | COAHS Student Portal </title>
                    ...
                    <div class="container-fluid">
                        <div class="row mb-2 align-items-center">
                            ...
                            <div class="col-sm-6 text-right">
                                <a id="addNewSubjectBtn" class="btn btn-secondary" href="admin-enrolled-student-view.php?school_year=<?php echo $school_year; ?>&semester=<?php echo $semester; ?>">
                                    ...
                                    if (isset($_GET['account_number'])) {
                                        ...
                                        if ($result && $result->num_rows > 0) {
                                            ...
                                            <div class="col-md-auto ml-auto">
                                                ...
                                                <!-- <form method="post" action="indexes/admin-students-reset-password.php"
                                                    class="d-inline">
