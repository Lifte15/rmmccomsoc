...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'COAHS') {
    ...
    <head>
        ...
        <title>Officer Payment View | COAHS Student Portal </title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                                        ...
                                        <div class="table-responsive">
                                            <table class="subject-info">
                                                ...
                                                if (isset($_GET['payment_for_id'])) {
                                                    ...
                                                    $eventsql = "SELECT * FROM payment_for WHERE payment_for_id = '$payment_for_id' AND department='COAHS'";
                        ...
                        WHERE payment.payment_for_id = '$payment_for_id'  AND user.department='COAHS'";
