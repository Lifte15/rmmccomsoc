...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'COAHS') {
  ...
  <head>
    ...
    <title>Admin Enroll Page | COAHS Student Portal </title>
                        ...
                        <td class="align-middle text-center">
                          ...
                          <form method="POST" action="indexes/admin-unenroll.php">
                            ...
                            <input type="hidden" name="previous_url"
                              ...
                              <a href='admin-enrolled-student-view-indi.php?account_number=<?php echo $row['account_number']; ?>&school_year=<?php echo $school_year; ?>&semester=<?php echo $semester; ?>'
