...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'COAHS') { 
  ...
  <head>
    ...
    <title>Officer Payment Page | COAHS Student Portal </title>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    if (!empty($conditions)) {
                      ...
                      if (!empty($search_input)) {
                        $eventssql = "SELECT * FROM payment_for WHERE $condition_string AND payment_description LIKE '%$search_input%' AND department='COAHS' AND FIND_IN_SET('$organization', organization)";
                      } else {
                        $eventssql = "SELECT * FROM payment_for WHERE $condition_string AND department='COAHS' AND FIND_IN_SET('$organization', organization)";
                      }
                    } else {
                      if (!empty($search_input)) {
                        $eventssql = "SELECT * FROM payment_for WHERE payment_description LIKE '%$search_input%' AND department='COAHS' AND FIND_IN_SET('$organization', organization)";
                      } else {
                        $eventssql = "SELECT * FROM payment_for WHERE department='COAHS' AND FIND_IN_SET('$organization', organization)";
                      }
                    }
                  }
