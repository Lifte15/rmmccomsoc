...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'COAHS') {
  ...
  <head>
    ...
    <title>Officer Add New Student | COAHS Student Portal</title>
                        ...
                        <div class="col-sm-12">
                          <?php if (isset($_GET['program'])) { ?>
                            <select class="form-control" id="program" name="program">
                              ...
                              <option value="BSN" <?php if ($_GET['program'] == 'BSN')
                                echo 'selected'; ?>>BSN</option>
                              <option value="BSP" <?php if ($_GET['program'] == 'BSP')
                                echo 'selected'; ?>>BSP</option>
                              <option value="BSM" <?php if ($_GET['program'] == 'BSM')
                                echo 'selected'; ?>>BSM</option>
                            </select>
                          <?php } else { ?>
                            <select class="form-control" id="program" name="program">
