...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'COAHS') {
  ...
  <head>
    ...
    <title>Officer Student Page | COAHS Student Portal</title>
                ...
                <tbody>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    if (!empty($condition_string)) {
                      $studentssql = "SELECT * FROM user WHERE $condition_string AND $column LIKE '%$search_input%' AND role = 'Student' AND department = 'COAHS' ORDER BY program ASC, year_level ASC, last_name ASC";
                    } else {
                      $studentssql = "SELECT * FROM user WHERE $column LIKE '%$search_input%' AND role = 'Student' AND department = 'COAHS' ORDER BY program ASC, year_level ASC, last_name ASC";
                    }
                  } else {
                    $studentssql = "SELECT * FROM user WHERE role = 'Student' AND department = 'COAHS' ORDER BY program ASC, year_level ASC, last_name ASC";
                  }
