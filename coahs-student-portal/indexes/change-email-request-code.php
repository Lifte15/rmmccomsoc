...
function sendMail($newEmail, $verificationCode, $username)
{
    ...
    try {
        ...
        $mail->setFrom('studentportal.comsoc@gmail.com', 'Change Email Address Request Code | COAHS Student Portal');
        $mail->addAddress($newEmail);

        $mail->isHTML(true);
        $mail->Subject = 'Change Email Address Request Code | COAHS Student Portal';
        $mail->Body =  "
        <html>
        <head>
            <style>
