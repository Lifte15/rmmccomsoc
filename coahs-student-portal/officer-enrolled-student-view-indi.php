...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'COAHS') {
    ...
    <head>
        ...
        <title>Officer Student View | COAHS Student Portal </title>
                    ...
                    <div class="container-fluid">
                        <div class="row mb-2 align-items-center">
                            ...
                            <div class="col-sm-6 text-right">
                                <a id="addNewSubjectBtn" class="btn btn-secondary" href="officer-enrolled-student-view.php?school_year=<?php echo $school_year; ?>&semester=<?php echo $semester; ?>">
                                    ...
                                    if (isset($_GET['account_number'])) {
                                        ...
                                        if ($result && $result->num_rows > 0) {
                                            ...
                                            <div class="col-md-auto">
                                                <img src="profile-pictures/<?php echo $row['profile_picture']; ?>"
                                            ...
                                            <div class="col-md-auto ml-auto">
                                                ...
                                                <!-- <form method="post" action="indexes/officer-students-reset-password.php"
                                                    class="d-inline">
                        ...
                        <div class="card card-primary card-outline bg-white mt-4">
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="#attendance"
