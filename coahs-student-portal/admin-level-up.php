                ...
                <div class="form-group row mb-3">
                    <div class="col-sm-3">
                        <select class="form-control" id="program" name="program">
                            ...
                            <option value="BSN" <?php if (isset($_GET['program']) && $_GET['program'] == 'BSN') echo 'selected'; ?>>BSN</option>
                            <option value="BSP" <?php if (isset($_GET['program']) && $_GET['program'] == 'BSP') echo 'selected'; ?>>BSP</option>
                            <option value="BSM" <?php if (isset($_GET['BSM']) && $_GET['program'] == 'BLIS') echo 'selected'; ?>>BSM</option>
                        </select>
                    </div>
