...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'COAHS') {
  ...
  <head>
    ...
    <title>Admin Events Page | COAHS Student Portal</title>
                ...
                <tbody>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    if (!empty($conditions)) {
                      ...
                      $eventssql = "SELECT * FROM events WHERE $condition_string AND event_name LIKE '%$search_input%' AND department='COAHS'";
                    } else {
                      $eventssql = "SELECT * FROM events WHERE event_name LIKE '%$search_input%' AND department='COAHS'";
                    }
                  } else {
                    $eventssql = "SELECT * FROM events WHERE department='COAHS'";
                  }
