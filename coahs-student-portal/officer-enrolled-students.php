...
<head>
    ...
    <title>Officer Query Page | COAHS Student Portal</title>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <select class="form-control" id="school_year" name="school_year">
                                            <option value="All" <?php if (isset($_GET['school_year']) && $_GET['school_year'] == 'All') echo 'selected'; ?>>All</option>
                                            <?php foreach ($schoolYears as $year) { ?>
                                            <option value="<?php echo $year['school_year']; ?>" <?php if (isset($_GET['school_year']) && $_GET['school_year'] == $year['school_year']) { echo 'selected'; } elseif (!isset($_GET['school_year']) && $year['dfault'] == 1) { echo 'selected'; } ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <select class="form-control" id="semester" name="semester">
                                            <option value="" <?php if (!isset($_GET['semester'])) echo 'selected'; ?>>All</option>
                                            <?php foreach ($semesters as $semester) { ?>
                                            <option value="<?php echo $semester['semester']; ?>" <?php if (isset($_GET['semester']) && $_GET['semester'] == $semester['semester']) { echo 'selected'; } elseif (!isset($_GET['semester']) && $semester['dfault'] == 1) { echo 'selected'; } ?>>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT sy.school_year, sem.semester, COUNT(DISTINCT u.account_number, u.department) AS num_students
                                ...
                                LEFT JOIN user u ON e.account_number = u.account_number AND u.department = 'COAHS'
