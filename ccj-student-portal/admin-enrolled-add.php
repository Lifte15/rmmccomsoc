...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CCJ') { // Check if the role is set and it's 'Admin'
  ...
  <head>
    ...
    <title>Admin Add Enrolee Page | CCJ Student Portal</title>
              ...
              <div class="col-sm-6">
                ...
                <form method="GET">
                  <input type="hidden" name="school_year"
                    value="<?php echo isset($_GET['school_year']) ? $_GET['school_year'] : ''; ?>">
                  <input type="hidden" name="semester"
                    value="<?php echo isset($_GET['semester']) ? $_GET['semester'] : ''; ?>">
              </div>
              <div class="col-sm-6 text-right">
                <a id="addNewSubjectBtn" class="btn btn-secondary"
                  href="admin-enrolled-student-view.php?school_year=<?php echo isset($_GET['school_year']) ? $_GET['school_year'] : ''; ?>&semester=<?php echo isset($_GET['semester']) ? $_GET['semester'] : ''; ?>"><i
                ...
                <div class="input-group-prepend col-2">
                  <select class="form-control" id="year_level" name="year_level">
                    <option value="all" <?php if (!isset($_GET['year_level']) || $_GET['year_level'] == 'all')
                      echo 'selected'; ?>>All Year Levels</option>
                ...
                <div class="input-group-prepend col-2">
                  <select class="form-control" id="program" name="program">
                    <option value="all" <?php if (!isset($_GET['program']) || $_GET['program'] == 'all')
                      echo 'selected'; ?>>All Programs</option>
                    <option value="BSCrim" <?php if (isset($_GET['program']) && $_GET['program'] == 'BSCrim')
                      echo 'selected'; ?>>BSCrim</option>
                  </select>
                </div>
