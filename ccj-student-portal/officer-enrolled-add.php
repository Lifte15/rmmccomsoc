...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CCJ') {
  ...
  <head>
    ...
    <title>Officer Add Enrolee Page | CCJ Student Portal</title>
            ...
            <div class="row mb-2 align-items-center">
              ...
              <div class="col-sm-6 text-right">
                <a id="addNewSubjectBtn" class="btn btn-secondary"
                  href="officer-enrolled-student-view.php?school_year=<?php echo isset($_GET['school_year']) ? $_GET['school_year'] : ''; ?>&semester=<?php echo isset($_GET['semester']) ? $_GET['semester'] : ''; ?>"><i
