...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CCJ') {
    ...
    <head>
        ...
        <title>Admin Edit Event Information | CCJ Student Portal</title>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 ml-4">
                                                    <?php
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="bep" name="organization[]"
                                                                value="Bulls Eye Publication" <?php if (in_array('Bulls Eye Publication', $organizations))
                                                                    echo 'checked'; ?>>
                                                            <label class="form-check-label" for="bep">Bulls Eye Publication</label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="rotc" name="organization[]"
