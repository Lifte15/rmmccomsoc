...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CCJ') { // Check if the role is set and it's 'Admin'
  ...
  <head>
    ...
    <title>Admin Payment Page | CCJ Student Portal </title>
              ...
              <tbody>
                ...
                if (isset($_GET['search'])) {
                  ...
                  if (!empty($conditions)) {
                    ...
                    $eventssql = "SELECT * FROM payment_for WHERE $condition_string AND payment_description LIKE '%$search_input%'  AND department='CCJ'";
                  } else {
                    $eventssql = "SELECT * FROM payment_for WHERE payment_description LIKE '%$search_input%' AND department='CCJ'";
                  }
                } else {
                  $eventssql = "SELECT * FROM payment_for WHERE department='CCJ'";
                }
