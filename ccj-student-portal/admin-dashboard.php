...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CCJ') { // Check if the role is set and it's 'Admin'
  ?>
  ...
  <head>
    ...
    <title>Admin Dashboard | CCJ Student Portal </title>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="row">
              <?php
              $officerquery = "SELECT COUNT(*) AS count FROM user WHERE role = 'Officer' AND department='CCJ'";
              ...
              $paymentforquery = "SELECT COUNT(*) AS count FROM payment_for
                 ...
                 AND payment_for.department = 'CCJ'";
    ...
    // BSCrim
    $BSCrimProgramquery = "SELECT COUNT(DISTINCT u.account_number) AS count 
                 FROM user u
                 INNER JOIN enrolled e ON u.account_number = e.account_number 
                 WHERE u.role = 'Student' 
                 AND u.program = 'BSCrim' 
                 AND e.school_year = '$schoolYear' 
                 AND e.semester = '$semester'
                 AND u.department='CCJ'";
    $BSCrimProgramresult = mysqli_query($conn, $BSCrimProgramquery);

    if ($BSCrimProgramresult) {
      $BSCrimProgramrow = mysqli_fetch_assoc($BSCrimProgramresult);
      $BSCrimProgramCount = $BSCrimProgramrow['count'];
    } else {
      $BSCrimProgramCount = 0;
    }
    ?>
    ...
    <script>
      $(function () {
        ...
        var BSCrimProgramCount = <?php echo $BSCrimProgramCount; ?>;
        var donutData = {
          labels: [
            'BSCrim',
          ],
