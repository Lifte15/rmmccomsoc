...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CCJ') { // Check if the role is set and it's 'Admin'
    ...
    <head>
        ...
        <title>Admin Payment View | CCJ Student Portal </title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                                        ...
                                        <div class="table-responsive">
                                            <table class="subject-info">
                                                ...
                                                if (isset($_GET['payment_for_id'])) {
                                                    ...
                                                    $eventsql = "SELECT * FROM payment_for WHERE payment_for_id = '$payment_for_id' AND department='CCJ'";
                        ...
                        WHERE payment.payment_for_id = '$payment_for_id'  AND user.department='CCJ'";
