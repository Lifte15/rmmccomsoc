...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CCJ') {
  ...
  <head>
    ...
    <title>Officer Add Bulk Student | CCJ Student Portal</title>
              ...
              <div class="col-md-8">
                <div class="card card-primary card-outline bg-white" for="new-subject">
                  <div class="card-header">
                    ...
                    <p class="text-muted">Please download this <a download="ccj-student-portal-guide"
                        href="excel/ccj-student-portal-guide.xlsx">ccj-portal-excel</a> for the guide:</strong></p>
                    <hr>
