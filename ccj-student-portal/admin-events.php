...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CCJ') { // Check if the role is set and it's 'Admin'
  ...
  <head>
    ...
    <title>Admin Events Page | CCJ Student Portal</title>
                ...
                <tbody>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    if (!empty($conditions)) {
                      ...
                      $eventssql = "SELECT * FROM events WHERE $condition_string AND event_name LIKE '%$search_input%' AND department='CCJ'";
                    } else {
                      $eventssql = "SELECT * FROM events WHERE event_name LIKE '%$search_input%' AND department='CCJ'";
                    }
                  } else {
                    $eventssql = "SELECT * FROM events WHERE department='CCJ'";
                  }
