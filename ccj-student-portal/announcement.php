...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Student' && $_SESSION['department'] === 'CCJ') {
    ...
    <head>
        ...
        <title>Announcements | CCJ Student Portal</title>
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        ...
                        if ($enrolled) {
                            ...
                            $sql = "SELECT * FROM announcement WHERE 1=1 AND department='CCJ'";
