...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CAS') {
  ...
  <head>
    ...
    <title>Admin Create New Event Page | CAS Student Portal</title>
                      ...
                      <div class="form-group row">
                        <div class="col-sm-12 ml-4">
                          ...
                          if (isset($_GET['organization'])) {
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" id="jem" name="organization[]"
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" id="jswap" name="organization[]" value="Junior Social Workers Association of the Philippines"
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" id="mplsw" name="organization[]"
                          ...
                          <?php } else { ?>
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" id="jem" name="organization[]"
                                value="Junior Ecologist Movement">
                              <label class="form-check-label" for="jem">Junior Ecologist Movement</label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" id="jswap" name="organization[]" value="Junior Social Workers Association of the Philippines">
