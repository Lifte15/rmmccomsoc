...
function sendMail($email, $v_code, $last_name, $first_name, $middle_name, $program, $year_level, $username)
{
    ...
    try {
        ...
        $mail->setFrom('studentportal.comsoc@gmail.com', 'Account Verification Code | CAS Student Portal');
        $mail->addAddress($email);

        $mail->isHTML(true);
        $mail->Subject = 'Hello CAS Student | CAS Student Portal';
        $mail->Body = "
        <html>
        ...
        <head>
            ...
            <body>
                <div class='container'>
                    ...
                    <hr>
                    <h3>To finalize your CAS Student Portal account, please verify your account using the following verification code:</h3>
