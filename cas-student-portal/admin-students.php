...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CAS') { // Check if the role is set and it's 'Admin'
  ...
  <head>
    ...
    <title>Admin Student Page |CAS Student Portal</title>
              ...
              <tbody>
                ...
                if (isset($_GET['search'])) {
                  ...
                  if (!empty($condition_string)) {
                    $studentssql = "SELECT * FROM user WHERE $condition_string AND $column LIKE '%$search_input%' AND role = 'Student' AND department = 'CAS' ORDER BY program ASC, year_level ASC, last_name ASC";
                  } else {
                    $studentssql = "SELECT * FROM user WHERE $column LIKE '%$search_input%' AND role = 'Student' AND department = 'CAS' ORDER BY program ASC, year_level ASC, last_name ASC";
                  }
                } else {
                  $studentssql = "SELECT * FROM user WHERE role = 'Student' AND department = 'CAS'  ORDER BY program ASC, year_level ASC, last_name ASC";
                }
