<!-- officer-payment-view.php and to view payments in admin form.
Authors:
...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CAS') { // Check if the role is set and it's 'Admin'
    ?>
    ...
    <head>
        ...
        <title>Admin Payment View | CAS Student Portal </title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
                                        ...
                                        <div class="table-responsive">
                                            <table class="subject-info">
                                                ...
                                                if (isset($_GET['payment_for_id'])) {
                                                    ...
                                                    $eventsql = "SELECT * FROM payment_for WHERE payment_for_id = '$payment_for_id' AND department='CAS'";
                                                    ...
                                                    if ($result && $result->num_rows > 0) {
                                                        ...
                                                        <table class="subject-info">
                                                            ...
                                                            <tr>
                                                                <td class="col-md-3"><strong>Number of Paid:</strong></td>
                                                                <td class="col-md-9"><?php echo $paid; ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="col-md-3"><strong>Number of Unpaid:</strong></td>
                                                                <td class="col-md-9"><?php echo $unpaid; ?></td>
                                                            </tr>
                                                        </table>
                                                    </table>
                                                </div>
          ...
          WHERE payment.payment_for_id = '$payment_for_id'  AND user.department='CAS'";
