 <!-- developer-profile.php and to see your profile account in admin form.
Authors:
...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Developer' && $_SESSION['department'] === 'DEVELOPER') {
    ...
    <head>
        ...
        <title>Admin Profile | CE Student Portal</title>
                                ...
                                <div class="card card-primary card-outline">
                                    <div class="card-body box-profile">
                                        ...
                                        <ul class="list-group list-group-unbordered mb-3">
                                            ...
                                            <br>
                                            <a href="developer-profile-setting.php" class="btn btn-primary btn-block">Edit my
                                                profile</a>
