<?php
/*
developer-admin-edit-be.php for editing officer details
Authors:
...
if (isset($_POST['editOfficer'])) {
    ...
    // Get the username of the developer who updated the officer
    ...
    elseif (empty($firstname)) {
        ...
        exit();
            ...
            if ($result_updateofficer_query) {
                header("Location: ../developer-admin.php?editOfficerSuccess=Officer account updated successfully");
                exit();
            } else {
                // Log detailed error information
                $error_message = "Failed to update officer account: " . mysqli_error($conn);
                error_log($error_message);
                header("Location: ../developer-admin-edit.php?account_number=$account_number&editOfficerError=" . urlencode($error_message) . "");
                exit();
            }
        }
