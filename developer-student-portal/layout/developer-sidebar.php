...
<aside class="main-sidebar sidebar-dark-danger elevation-4"
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
      ...
      ?>
      <div class="info ml-2">
        <a href="developer-profile.php" class="d-block">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item ">
          <a href="developer-events.php?search_input=&date=&school_year=<?php echo $defaultYear; ?>&semester=<?php echo $defaultSemester; ?>&search=" class="nav-link">
        ...
        <li class="nav-item ">
          <a href="developer-payment.php?search_input=&date=&school_year=<?php echo $defaultYear; ?>&semester=<?php echo $defaultSemester; ?>&search=" class="nav-link">
        ...
        <li class="nav-item ">
          <a href="developer-academic-settings.php" class="nav-link">
        ...
        <!-- <li class="nav-item ">
          <a href="developer-level-up.php" class="nav-link">
