<!-- developer-profile-setting.php and to edit your account profile in admin form.
Authors:
...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Developer'  && $_SESSION['department'] === 'DEVELOPER') { // Check if the role is set and it's 'Admin'
    ...
    <head>
        ...
        <title>Admin Profile Seetings | CE Student Portal</title>
                                            ...
                                            <div class="active tab-pane" id="settings">
                                                ...
                                                <div class="card card-primary card-outline bg-white"
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <form style="width: 100%"
                                                            action="indexes/developer-update-profilepicture.php" method="post"
                                                ...
                                                <div class="card card-primary card-outline bg-white" for="change-email">
                                                    <div class="card-header">
                                                        ...
                                                        <form style="width: 100%"
                                                            action="indexes/developer-change-email-request-code.php"
                                                            method="post">
                                                        ...
                                                        <form style="width: 100%" action="indexes/developer-changemail-be.php"
                                                            method="post">
                                                ...
                                                <div class="card card-primary card-outline bg-white" for="change-password">
                                                    <div class="card-header">
                                                        ...
                                                        <?php } ?>
                                                        <form style="width: 100%"
                                                            action="indexes/developer-changepassword-be.php" method="post">
                                                            <div class="mb-3">
