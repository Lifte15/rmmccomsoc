...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CTE') {
  ...
  <head>
    ...
    <title>Admin Student Page | CTE Student Portal</title>
          ...
          <div class="container-fluid">
            <div class="row mb-2 align-items-center">
              ...
              <div class="col-sm-6 text-right">
                <a id="addNewStudentBtn" class="btn btn-success" href="developer-student-addnew.php"><i
                ...
                <tbody>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    if (!empty($condition_string)) {
                      $studentssql = "SELECT * FROM user WHERE $condition_string AND $column LIKE '%$search_input%' AND role = 'Student' AND department = 'CTE' ORDER BY program ASC, year_level ASC, last_name ASC";
                    } else {
                      $studentssql = "SELECT * FROM user WHERE $column LIKE '%$search_input%' AND role = 'Student' AND department = 'CTE' ORDER BY program ASC, year_level ASC, last_name ASC";
                    }
                  } else {
                    $studentssql = "SELECT * FROM user WHERE role = 'Student' AND department = 'CTE' ORDER BY program ASC, year_level ASC, last_name ASC";
                  }
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <tr>
                        ...
                        <td class="align-middle text-center">
                          ...
                          <a href='developer-students-delete.php?account_number=<?php echo $row['account_number']; ?>'
