              ...
              <tbody>
                ...
                if (isset($_GET['search'])) {
                  ...
                  if (!empty($condition_string)) {
                    $studentssql = "SELECT * FROM user WHERE $condition_string AND $column LIKE '%$search_input%' AND role = 'Student' ORDER BY department ASC, program ASC, year_level ASC, last_name ASC";
                  } else {
                    $studentssql = "SELECT * FROM user WHERE $column LIKE '%$search_input%' AND role = 'Student' ORDER BY department ASC, program ASC, year_level ASC, last_name ASC";
                  }
                } else {
                  $studentssql = "SELECT * FROM user WHERE role = 'Student' ORDER BY department ASC, program ASC, year_level ASC, last_name ASC";
                }
