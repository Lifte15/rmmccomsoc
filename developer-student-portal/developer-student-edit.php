...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Developer' && $_SESSION['department'] === 'DEVELOPER') {
    ...
    <head>
        ...
        <title>Developer Edit Student | Dev Portal </title>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="card card-primary card-outline bg-white" for="new-subject">
                                    <div class="card-header">
                                        ...
                                        <form action="indexes/developer-student-edit-be.php" method="post">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" id="program" name="program">
                                                                ...
                                                                $programs = ['BEEd', 'BECEd', 'BCAEd', 'BPEd', 'BTLEd', 'BSEd-English', 'BSEd-Filipino', 'BSEd-Math', 'BSEd-Science', 'BSEd-Social Studies'];
                                                                    ...
                                                                    $programs = ['BSA', 'BSMA', 'BSBA-FM', 'BSBA-MM', 'BSBA-OM', 'BSOA', 'BSCA', 'BSREM', 'BSTM', 'BSHM'];
                                                                } elseif ($department == "CCJ") {
                                                                    $programs = ['BSCrim'];
                                                                } elseif ($department == "CE") {
                                                                    $programs = ['BSCE'];
                                                                } elseif ($department == "COAHS") {
                                            ...
                                            <div class="offset-sm-2 col-sm-10">
                                                ...
                                                <a type="button" name="cancel" class="btn btn-secondary"
                                                    href="developer-student-view.php?account_number=<?php echo $_GET['account_number']; ?>&school_year=<?php echo $_GET['school_year']; ?>&semester=<?php echo $_GET['semester']; ?>">Cancel</a>
