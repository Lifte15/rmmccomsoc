<!-- developer-officer-delete.php and to delete officer in developer form.
Authors:
...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Developer' && $_SESSION['department'] === 'DEVELOPER') { // Check if the role is set and it's 'Admin'
    ...
    <head>
        ...
        <title>Developer Edit Officer | Dev Portal </title>
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Edit Admin's Information</h1>
                            </div>
                        </div>
                    </div>
                </div>
