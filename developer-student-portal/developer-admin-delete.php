<!-- developer-admin-delete.php and to delete admin in developer form.
Authors:
...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Developer' && $_SESSION['department'] === 'DEVELOPER') {
    ...
    <head>
        ...
        <title>Developer Delete Admin | Dev Portal </title>
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Deleting Admin</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card card-danger card-outline bg-white" for="new-subject">
                                    <div class="card-header">
                                        <h3 class="card-title text-center" style="font-size: 1.25rem; font-weight: bold;">
                                            Are you sure you want to delete this admin?</h3><br>
                                        ...
                                        <form action="indexes/developer-admin-delete-be.php" method="post">
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    $displayeddepartment = $department;
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="created_on_original"
                                                                placeholder="(Required)" value="<?php echo $displayeddepartment; ?>"
                                                                disabled>
                                            ...
                                            <div class="offset-sm-2 col-sm-10">
                                                ...
                                                <a type="button" name="cancel" class="btn btn-secondary"
                                                    href="developer-admin.php">Cancel</a>
                                            </div>
                                        </form>
