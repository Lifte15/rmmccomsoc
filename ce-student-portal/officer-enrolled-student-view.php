...
<!-- officer-enrolled-student-view.php and to see the student enrolled in that SY and Semester in admin form.
Authors:
...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CE') { 
  ...
  <head>
    ...
    <title>Officer Enroll Page | CE Student Portal </title>
