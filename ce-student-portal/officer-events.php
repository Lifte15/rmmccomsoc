                ...
                <tbody>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    if (!empty($conditions)) {
                      ...
                      $eventssql = "SELECT * FROM events WHERE $condition_string AND event_name LIKE '%$search_input%' AND department='CE'";
                    } else {
                      $eventssql = "SELECT * FROM events WHERE event_name LIKE '%$search_input%' AND department='CE'";
                    }
                  } else {
                    $eventssql = "SELECT * FROM events WHERE department='CE'";
                  }
