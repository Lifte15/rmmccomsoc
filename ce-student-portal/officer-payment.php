...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CE') { 
  ...
  <head>
    ...
    <title>Officer Payment Page | CE Student Portal </title>
                ...
                <tbody>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    if (!empty($conditions)) {
                      ...
                      $eventssql = "SELECT * FROM payment_for WHERE $condition_string AND payment_description LIKE '%$search_input%'  AND department='CE'";
                    } else {
                      $eventssql = "SELECT * FROM payment_for WHERE payment_description LIKE '%$search_input%' AND department='CE'";
                    }
                  } else {
                    $eventssql = "SELECT * FROM payment_for WHERE department='CE'";
                  }
