...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CE') {
    ...
    <head>
        ...
        <title>Officer Event View | CE Student Portal </title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                                        ...
                                        <div class="table-responsive">
                                            <table class="subject-info">
                                                ...
                                                if (isset($_GET['event_id'])) {
                                                    ...
                                                    $eventsql = "SELECT * FROM events WHERE event_id = '$event_id' AND department='CE'";
                        ...
                        FROM attendance 
                        JOIN user ON attendance.account_number = user.account_number AND user.department = 'CE'
