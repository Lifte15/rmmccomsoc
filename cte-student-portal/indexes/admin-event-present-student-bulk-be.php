...
if (isset($_POST['save_excel_data'])) {
    ...
    if (in_array($file_ext, $allowed_ext)) {
        ...
        try {
            ...
            header("Location: ../admin-event-view.php?event_id=$event_id&present_count=$updated_count&not_present_count=$not_present_count&report_path=" . urlencode($report_url_path));
            exit();
