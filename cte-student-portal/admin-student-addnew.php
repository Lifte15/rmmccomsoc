...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin' && $_SESSION['department'] === 'CTE') {
  ?>
  ...
  <head>
    ...
    <title>Admin Add New Student | CTE Student Portal</title>
                        ...
                        <div class="col-sm-12">
                          <?php if (isset($_GET['program'])) { ?>
                            <select class="form-control" id="program" name="program">
                              ...
                              <option value="BEEd" <?php if ($_GET['program'] == 'BEEd')
                                echo 'selected'; ?>>BEEd</option>
                              <option value="BECEd" <?php if ($_GET['program'] == 'BECEd')
                                echo 'selected'; ?>>BECEd</option>
                              <option value="BCAEd" <?php if ($_GET['program'] == 'BCAEd')
                                echo 'selected'; ?>>BCAEd</option>
                              <option value="BPEd" <?php if ($_GET['program'] == 'BPEd')
                                echo 'selected'; ?>>BPEd</option>
				<option value="BTLEd" <?php if ($_GET['program'] == 'BTLEd')
                                echo 'selected'; ?>>BTLEd</option>
                              <option value="BSEd-English" <?php if ($_GET['program'] == 'BSEd-English')
                                echo 'selected'; ?>>BSEd-English</option>
                              <option value="BSEd-Filipino" <?php if ($_GET['program'] == 'BSEd-Filipino')
                                echo 'selected'; ?>>BSEd-Filipino</option>
                              <option value="BSEd-Math" <?php if ($_GET['program'] == 'BSEd-Math')
                                echo 'selected'; ?>>BSEd-Math</option>
                              <option value="BSEd-Science" <?php if ($_GET['program'] == 'BSEd-Science')
                                echo 'selected'; ?>>BSEd-Science</option>
                              <option value="BSEd-Social Studies" <?php if ($_GET['program'] == 'BSEd-Social Studies')
                                echo 'selected'; ?>>BSEd-Social Studies</option>
                            </select>
                          <?php } else { ?>
                            <select class="form-control" id="program" name="program">
