...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CTE') {
  ...
  <head>
    ...
    <title>Officer Add Bulk Student | CTE Student Portal</title>
              ...
              <div class="col-md-8">
                <div class="card card-primary card-outline bg-white" for="new-subject">
                  <div class="card-header">
                    ...
                    <p class="text-muted">Please download this <a download="cte-student-portal-guide"
                        href="excel/cte-student-portal-guide.xlsx">cte-portal-excel</a> for the guide:</strong></p>
                    <hr>
