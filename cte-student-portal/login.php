 <!-- login.php and to login in CTE Student Portal.
Authors:
...
<head>
    ...
    <title>CTE Student Portal</title>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-5">
                                                    <div class="text-center mb-2">
                                                        <img src="images/ite.png" alt="cte Student Portal Logo"
                                                            width="80" height="80">
                                                    </div>
                                                    <h3 class="text-center">Welcome back CTE Students!</h3>
                                                </div>
                                            </div>
                                        </div>
