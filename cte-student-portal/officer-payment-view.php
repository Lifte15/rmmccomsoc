...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Officer' && $_SESSION['department'] === 'CTE') { // Check if the role is set and it's 'Admin'
    ?>
    ...
    <head>
        ...
        <title>Admin Payment View | CTE Student Portal </title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
                                        ...
                                        <div class="table-responsive">
                                            <table class="subject-info">
                                                ...
                                                if (isset($_GET['payment_for_id'])) {
                                                    ...
                                                    $eventsql = "SELECT * FROM payment_for WHERE payment_for_id = '$payment_for_id' AND department='CTE'";
          ...
          WHERE payment.payment_for_id = '$payment_for_id'  AND user.department='CTE'";
